 ...
 *
 *   // network
 *   CSimplecointestNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.simplecointest.org/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CSimplecointestNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
public:
    CSimplecointestNetwork(UniValue objIn)
    {
...
// // can be under: SimplecointestNetwork
// //   -- signature requirements : Key1(User)
// class CSimplecointestNetworkVariable : public CGovernanceObject
// {
// private:
...
//     //     return (IsType() == SimplecointestNetwork);
//     // }
