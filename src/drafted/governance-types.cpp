...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "SimplecointestNetwork") type = SimplecointestNetwork;
    if(strType == "SimplecointestNetworkVariable") type = SimplecointestNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == SimplecointestNetwork) s = "SimplecointestNetwork";
    if(type == SimplecointestNetworkVariable) s = "SimplecointestNetworkVariable";
