    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Simplecointest Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Simplecointest address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and simplecointest: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Simplecointest Core"), this);
    aboutAction->setStatusTip(tr("Show information about Simplecointest Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Simplecointest Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Simplecointest addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Simplecointest addresses"));
    ...
    openAction->setStatusTip(tr("Open a simplecointest: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Simplecointest Core help message to get a list with possible Simplecointest Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Simplecointest Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Simplecointest network", "", count));
    } else {
...
{
    QString strTitle = tr("Simplecointest Core"); // default title
    ...
    // Append title to "Simplecointest Core - "
    if (!msgType.isEmpty())
        strTitle += " - " + msgType;
