    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("SIMPLECOINTEST-light"), QVariant("light"));
    ui->theme->addItem(QString("SIMPLECOINTEST-light-hires"), QVariant("light-hires"));
    ui->theme->addItem(QString("SIMPLECOINTEST-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("SIMPLECOINTEST-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("SIMPLECOINTEST-traditional"), QVariant("trad"));
