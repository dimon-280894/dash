    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Simplecointest Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About Simplecointest Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  simplecointest-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the Simplecointest in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 SIMPLECOINTEST, 0.1 SIMPLECOINTEST, 1 SIMPLECOINTEST and 10 SIMPLECOINTEST -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://simplecointest.atlassian.net/wiki/display/DOC/PrivateSend\">https://simplecointest.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Simplecointest Core is shutting down...") + "<br /><br />" +
