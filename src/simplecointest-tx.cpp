...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("Simplecointest Core simplecointest-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  simplecointest-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded simplecointest transaction") + "\n" +
              "  simplecointest-tx [options] -create [commands]   " + _("Create hex-encoded simplecointest transaction") + "\n" +
              "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded simplecointest transaction
