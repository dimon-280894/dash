...
public:
    CMainParams() {
        ...
        consensus.nPowTargetTimespan = 24 * 60 * 60; // Simplecointest: 1 day
        consensus.nPowTargetSpacing = 2.5 * 60; // Simplecointest: 2.5 minutes
        ...
        vSeeds.push_back(CDNSSeedData("simplecointest.org", "dnsseed.simplecointest.org"));
        vSeeds.push_back(CDNSSeedData("simplecointestdot.io", "dnsseed.simplecointestdot.io"));
        vSeeds.push_back(CDNSSeedData("masternode.io", "dnsseed.masternode.io"));
        vSeeds.push_back(CDNSSeedData("simplecointest.io", "dnsseed.simplecointest.io"));
...
public:
    CTestNetParams() {
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        vSeeds.push_back(CDNSSeedData("simplecointestdot.io",  "testnet-seed.simplecointestdot.io"));
