Contributing to Simplecointest Core
============================

The Simplecointest Core project operates an open contributor model where anyone is welcome to contribute towards development in the form of peer review, testing and patches. This document explains the practical process and guidelines for contributing.
...
The following applies to code changes to the Simplecointest Core project (and related projects such as libsecp256k1), and is not to be confused with overall Simplecointest Network Protocol consensus changes.

Whether a pull request is merged into Simplecointest Core rests with the project merge maintainers and ultimately the project lead.
