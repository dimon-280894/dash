Simplecointest Core version 0.12.2
========================
...
We outline an initial scaling mechanism for Simplecointest. After deployment and activation, Simplecointest will be able to handle double the transactions it can currently handle. Together with the faster block times, Simplecointest we will be prepared to handle eight times the traffic of Bitcoin.

https://github.com/simplecointest/dips/blob/master/dip-0001.md


Fee reduction
-------------

All transaction fees are reduced 10x (from 10K per Kb to 1K per Kb), including fees for InstantSend (from 0.001 SIMPLECOINTEST per input to 0.0001 per input)
...
See `Help -> Command-line options` in Qt wallet or `simplecointestd --help` for more info.
...
Detailed [change log](https://github.com/dimon-280894/simple-coin-test/compare/v0.12.1.x...simplecointest:v0.12.2.x) below.

### Backports:
- [`ff30aed68`](https://github.com/dimon-280894/simple-coin-test/commit/ff30aed68) Align with btc 0.12 (#1409)
- [`9901cf433`](https://github.com/dimon-280894/simple-coin-test/commit/9901cf433) Fix for simplecointest-qt issue with startup and multiple monitors. (#1461)
...
- [`b0843c397`](https://github.com/dimon-280894/simple-coin-test/commit/b0843c397) Backport Bincoin PR#7348: MOVE ONLY: move rpc* to rpc/ + same for Simplecointest-specific rpc (#1502)
...
- [`6af9955fa`](https://github.com/dimon-280894/simple-coin-test/commit/6af9955fa) Backport Bitcoin PR#7696: Fix de-serialization bug where AddrMan is corrupted after exception (#1507)
...
- [`b9c67258b`](https://github.com/dimon-280894/simple-coin-test/commit/b9c67258b) Backport Bitcoin PR#9609: net: fix remaining net assertions (#1575) + Simplecointestify
...
- [`9707ca5ce`](https://github.com/dimon-280894/simple-coin-test/commit/9707ca5ce) Backport Bitcoin Qt/Gui changes up to 0.14.x part 2 (#1615)
...
- [`470e5435c`](https://github.com/dimon-280894/simple-coin-test/commit/470e5435c) remove InstantSend votes for failed lock attemts after some timeout (#1705)
...
- [`510c0a06d`](https://github.com/dimon-280894/simple-coin-test/commit/510c0a06d) Relay tx in sendrawtransaction according to its inv.type (#1584)
...
- [`753b1e486`](https://github.com/dimon-280894/simple-coin-test/commit/753b1e486) Eliminate remaining uses of g_connman in Simplecointest-specific code. (#1635)
...
- [`4df8a20f9`](https://github.com/dimon-280894/simple-coin-test/commit/4df8a20f9) Fix windows installer script, should handle `simplecointest:` uri correctly now (#1550)
...
- [`7ab175a8e`](https://github.com/dimon-280894/simple-coin-test/commit/7ab175a8e) Ensure Simplecointest wallets < 0.12.2 can't open HD wallets (#1638)
...
- [`7a5943c3a`](https://github.com/dimon-280894/simple-coin-test/commit/7a5943c3a) Merge pull request #1431 from simplecointest/v0.12.2.x-merge_upstream
...
- [`b40f8f333`](https://github.com/dimon-280894/simple-coin-test/commit/b40f8f333) Rename bitcoinconsensus library to simplecointestconsensus. (#1432)
...
- [`715504357`](https://github.com/dimon-280894/simple-coin-test/commit/715504357) Simplecointestify bitcoin unix executables (#1486)
...
- [`b22cda4df`](https://github.com/dimon-280894/simple-coin-test/commit/b22cda4df) typo: "Writting" -> "Writing" (#1605)
...
As well as Bitcoin Core Developers and everyone that submitted issues or helped translating on [Transifex](https://www.transifex.com/projects/p/simplecointest/).
...
Simplecointest Core tree 0.11.x was a fork of Bitcoin Core tree 0.9, Darkcoin was rebranded
to Simplecointest.
