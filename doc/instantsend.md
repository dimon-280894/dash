...
This mechanism has been integrated into Bitcore-Node-Simplecointest which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/simplecointest/insight-api-simplecointest#web-socket-api](https://github.com/simplecointest/insight-api-simplecointest#web-socket-api)
* API: [https://github.com/simplecointest/insight-api-simplecointest#instantsend-transactions](https://github.com/simplecointest/insight-api-simplecointest#instantsend-transactions)
...
By default, the Simplecointest Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Simplecointest Core daemon:
