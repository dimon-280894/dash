...
Only requiring some minor changes is simplecointest.cpp.
...
Changes to simplecointest.cpp
----------------------
simplecointest.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
