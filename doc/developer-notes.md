...
Simplecointest Core is a multithreaded application, and deadlocks or other multithreading bugs
...
However, in open source software such as Simplecointest Core, where everyone uses
...
pay attention to for reviewers of Simplecointest Core code.

General Simplecointest Core
----------------------
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: Simplecointest Core uses tinyformat, which is type safe. Leave them out to avoid confusion
